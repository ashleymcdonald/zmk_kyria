...
int zmk_widget_layer_status_init(struct zmk_widget_layer_status *widget, lv_obj_t *parent) {
    ...
    //lv_obj_set_width(widget->obj, LV_LABEL_PART_MAIN, 128);
    //didntwork//lv_obj_set_auto_realign(widget->obj, true);
    lv_label_set_align(widget->obj, LV_LABEL_ALIGN_CENTER);
